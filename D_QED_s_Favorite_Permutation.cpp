...
void solve()
{
    ...
    while(q--)
    {
        ...
        if(v1[in]==0 && s[in]=='L' && s[in+1]=='R')s1.insert(in); 
        if(v1[in-1]==0 && s[in-1]=='L' && s[in]=='R')s1.insert(in-1);   
          
        // if(s[in-1]=='L' && s[in]=='R' && v1[in]==0)s1.insert(in);
        // if(s[in]=='L' && s[in+1]=='R' && v1[in]==0)s1.insert(in+1);
