...
void solve()
{
    ...
    if(k>=3)
    {
        for(int i=1;i<n;i++)
        {
            ...
            {
                cnt++;
                if(i+1<n && ((s[i-1]=='A' && s[i+1]=='B') || (s[i-1]=='B' && s[i+1]=='A')))
                {
                    s[i]='C';
                }
                else if(s[i-1]=='A' || (i+1<n && s[i+1]=='A'))
                {
                    s[i]='B';
                }
                else
    ...
    else
    {
        ...
        for(int i=1;i<n;i++)
        {
            if(ans1[i]=='A' && ans1[i-1]=='A')
            {
                ans1[i]='B';
                c1++;
            }
            else if(ans1[i]=='B' && ans1[i-1]=='B')
            {
                ans1[i]='A';
                c1++;
            }
        ...
        string ans2=s;
        ll c2=1;
        if(ans2[0]=='A')ans2[0]='B';
        else ans2[0]='A';
        for(int i=1;i<n;i++)
        {
            if(ans2[i]=='A' && ans2[i-1]=='A')
            {
                ans2[i]='B';
                c2++;
            }
            else if(ans2[i]=='B' && ans2[i-1]=='B')
            {
                ans2[i]='A';
                c2++;
            }
